...
function Tv() {
  ...
  const content = () => {
    ...
    else if ((detail?.overview as string).length > 250) return detail?.overview.slice(0, 600) + "...";
    ...
    <Wrapper>
      {isLoading && popularLoading && onairLoading ? (
        ...
        <>
          ...
          <Slider>
            <>
              <SubTitle>오늘 방송되는 TV 프로그램</SubTitle>
              <Slider_row>
                      ...
                      .map((tv) => (
                        ...
                        >
                          ...
                          <Info variants={infoVariants} key={tv.id}>
                            {/* 부모로부터 hover */}
                            <h4>{tv.name}</h4>
                            <span className="material-symbols-outlined" onClick={() => onBoxClicked(tv.id + "")}>
                              expand_circle_down
                            </span>
                          </Info>
                        </Box>
                ...
                {detailLoading ? (
                  ...
                  <BigTv>
                    <>
                      ...
                      <BigDetail>
                        <div> Seasons : &nbsp;{detail?.number_of_seasons}</div>
                        <div> Episodes : &nbsp;{detail?.number_of_episodes}</div>
                        <div>
                          <h4>Type : &nbsp; </h4>
